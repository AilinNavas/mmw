...
function AnimatedBackground({ particleCount = 24, baseRadius = 60, speedMultiplier = 1.0 }) {
    ...
    const intensityRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0.6); // base intensity, 0..1
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedBackground.useEffect": ()=>{
            ...
            const unsub = scrollYProgress.onChange({
                "AnimatedBackground.useEffect.unsub": (v)=>{
                    // v is 0..1, map to intensity 0.3..1.2
                    const mapped = 0.3 + v * 0.9;
                    intensityRef.current = mapped;
                }
            }["AnimatedBackground.useEffect.unsub"]);
            // animation loop
            const animate = {
                "AnimatedBackground.useEffect.animate": (t)=>{
            ...
            const onResize = {
                "AnimatedBackground.useEffect.onResize": ()=>{
                    ...
                    lights.forEach({
                        "AnimatedBackground.useEffect.onResize": (L)=>{
...
_s(AnimatedBackground, "UKvLnjTru3mRpnnM/lAwxjlF8Aw=", false, function() {
    return [
...
//# sourceMappingURL=components_animatedBackground_tsx_558ccaa3._.js.map